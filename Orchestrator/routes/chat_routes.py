...
from Orchestrator.config import ANTHROPIC_API_KEY, ANTHROPIC_URL, AUTO_ENABLE, CFG, DEBOUNCE_MS, GEMINI_BASE_URL, GOOGLE_API_KEY, ON_RED, ON_YELLOW, OPENAI_API_KEY, OPENAI_URL, TOKENS_THRESHOLD, TURNS_THRESHOLD, UPLOADS_DIR, USERS_DEFAULT, VOL_PATH, XAI_API_KEY, XAI_URL
    ...
    try:
        ...
        if not model:
            if provider == "openai":
                ...
                model = "grok-4-1-fast-reasoning"  # Grok 4.1 with reasoning
