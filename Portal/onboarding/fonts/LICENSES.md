...
This directory contains self-hosted variable font files used by the AI BlackBox
onboarding wizard. Both fonts ship under the SIL Open Font License, Version 1.1
(SIL OFL 1.1). The full license text follows the per-font attribution block.

---

## Fraunces

- **Family:** Fraunces (variable, axes: SOFT, WONK, opsz, wght)
- **File:** `Fraunces.ttf`
...
- **Reserved Font Name:** "Fraunces"

## JetBrains Mono

- **Family:** JetBrains Mono (variable, axis: wght)
- **File:** `JetBrainsMono.ttf`
- **Source:** https://github.com/JetBrains/JetBrainsMono
- **Copyright:** Copyright 2020 The JetBrains Mono Project Authors
  (https://github.com/JetBrains/JetBrainsMono)
- **License:** SIL Open Font License, Version 1.1 (text below)
- **Reserved Font Name:** "JetBrains Mono"
