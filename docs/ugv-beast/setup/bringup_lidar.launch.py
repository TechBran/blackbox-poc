...
def generate_launch_description():
    ...
    # Remap base_node's /odom output to /odom_wheel so robot_localization EKF
    # (launched by slam_nav.launch.py) can own the /odom name. EKF fuses
    # /odom_wheel's twist.linear.x + /oak/imu's Vyaw and publishes the fused
    # result on /odom + odom->base_footprint TF. See ekf_oak.yaml.
    base_node = Node(
