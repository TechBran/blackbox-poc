...
class ugv_bringup(Node):
    ...
    def publish_odom_raw(self):
        ...
        # Wheel-encoder-to-meters scale. Waveshare stock used /100. Checkpoint C
        # (2026-04-20) on this chassis measured EKF reporting 1.116x physical
        # travel over two 3-foot runs (38.25/34 and 37.65/34). Scale bumped to
        # /111.6 to close the over-read. Recalibrate if chassis/track changes.
        _ENC_SCALE = 111.6
        array = [odom_raw_data["odl"]/_ENC_SCALE, odom_raw_data["odr"]/_ENC_SCALE]
